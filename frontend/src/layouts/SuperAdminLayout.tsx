                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <span className="hidden md:block text-sm font-medium text-amber-100 group-hover:text-amber-400 transition-colors">Super Admin</span>
            ...
            <div className="flex flex-1 overflow-hidden relative">
                ...
                >
                    <nav className="h-full px-4 py-6 space-y-2 overflow-y-auto">
                        <NavItem icon={<LayoutDashboard />} label="Dashboard" to="/super-admin/dashboard" active={location.pathname === '/super-admin/dashboard' || location.pathname === '/super-admin'} />
                        <NavItem icon={<CheckCircle />} label="Product Approvals" to="/super-admin/product-approvals" active={location.pathname === '/super-admin/product-approvals'} />
                        <NavItem icon={<Store />} label="Sellers" to="/super-admin/business-approvals" active={location.pathname === '/super-admin/business-approvals'} />
                        <NavItem icon={<Users />} label="Customers" to="/super-admin/customers" active={location.pathname === '/super-admin/customers'} />
                        <NavItem icon={<List />} label="Categories" to="/super-admin/categories" active={location.pathname === '/super-admin/categories'} />
                        <div className="pt-4 mt-6 border-t border-amber-500/20">
                            ...
                            <NavItem icon={<Settings />} label="Settings" to="/super-admin/settings" active={location.pathname === '/super-admin/settings'} />
                            <button
                                onClick={handleLogout}
                ...
                <div className="flex-1 flex flex-col min-w-0 overflow-hidden bg-[#1a120b] relative">
                    {/* Background Elements - copied from dashboard, maybe keep them here for all pages or let pages decide? 
                         Let's keep them here so it's consistent for all child pages.
                     */}
